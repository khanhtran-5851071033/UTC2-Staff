...
import 'package:utc2_staff/service/pdf/pdf_quiz_question.dart';
...
class QuizSreen extends StatefulWidget {
  ...
  QuizSreen({this.quiz, this.teacher, this.classUtc});
  @override
...
class _QuizSreenState extends State<QuizSreen> {
  ...
  void initState() {
    ...
    questionBloc.add(GetQuestionEvent(widget.teacher.id, widget.quiz.idQuiz));
  }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          TextButton.icon(
              onPressed: () async {
                final pdfFile = await PdfQuizApi.generate(
                    widget.teacher, widget.classUtc, widget.quiz, listQuestion);
                            ...
                            return RefreshIndicator(
                              onRefresh: () async {
                                questionBloc.add(GetQuestionEvent(
                                    widget.teacher.id, widget.quiz.idQuiz));
                              },
                              child: Scrollbar(
                                    ...
                                    itemBuilder: (context, index) {
                                      return Container(
                                        ...
                                        child: QuestionItem(
                                          ...
                                          option1: Option(
                                            answer:
                                                state.list[index].answerCorrect,
                                            value: 1,
